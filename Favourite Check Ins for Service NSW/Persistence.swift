...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        for n in 0..<10 {
            ...
            newItem.name = "Business Name"
            newItem.address = "123 Pacific Highway, Chatswood, NSW, AUSTRALIA"
            newItem.url = "https://google.com"
            newItem.order = n
    ...
    init(inMemory: Bool = false) {
        container = NSPersistentContainer(name: "Quick_Check_In_for_Service_NSW")
        if inMemory {
